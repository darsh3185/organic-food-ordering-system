<!DOCTYPE html>
         ...
         <div class="login__access">
            ...
            <div class="login__area">
               <form action="#" method="post">
                  ...
                  <button type="submit" class="login__button" name="login-btn"><a href="index.php" style="color: white;">Login</a></button>
               </form>
               <!-- Name Field -->
 ...
 ?>
         ...
         <div class="login__register">
            ...
            <div class="login__area">
               <form action="#" method="post">
                  ...
                  <button type="submit" class="login__button" name="reg-btn">Create account</button>
               </form>
      ...
      <!-- names  surnames   email  password  login-btn -->
      <!-- database conntection started -->
      <?php
 $server = "localhost";
 $user = "root";
 ...
 if(isset($_POST['reg-btn'])){
   ...
   $email  = $_POST['email'];
   $password  = $_POST['password'];
   $sql = "INSERT INTO register(Name,Surname,Email,Password)VALUES('$name','$sname','$email','$password')";
   $result = mysqli_query($con,$sql);
 }
 ?>
       <!-- database conntection ended-->
